...
@section('content')
    <div class="container-fluid mt-4">
        <h1 class="h3 mb-2 text-gray-800">Ubah Periode Akademik</h1>

        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{route('periode.prosesUbah')}}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="form-label">Periode Akademik</label>
                        <input type="text" name="jenis_periode" value="{{$periode->jenis_periode}}" class="form-control @error('jenis_periode') is-invalid @enderror">
                        @error('jenis_periode')
