            ...
            <div class="card-body">
                <form action="{{route('dosen.prosesUbah')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" value="{{$dosen->nama}}" class="form-control @error('nama') is-invalid @enderror">
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nidn" value="{{$dosen->nidn}}" class="form-control @error('nidn') is-invalid @enderror">
                        @error('nidn')
                        <span style="color: red; font-weight: 600; font-size: 9pt">{{$message}}</span>
                        @enderror
                    </div>
